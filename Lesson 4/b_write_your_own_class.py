...
class RewardsCard(CreditCard):
    def __init__(self, account_number, credit_limit, rewards_rate):
        ...
        self.rewards_card_balance = 0

    def accumulate_reward_points(self, amount):
        self.rewards_points += (self.rewards_rate * self.make_purchase(amount))


RewardsCard.accumulate_reward_points(1000)
